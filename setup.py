    ...
    for line in cpuinfo:
        if "Hardware" in line:
            ...
            if "sun4i" in processor:
                ...
                print ("Detected processor: " + print_color(processor) + " (Probably Allwinner A13/A10s/R8)")

            elif "sun6i" in processor:
                print ("Detected processor: " + print_color(processor) + " (Probably Allwinner A31/A31s)")

            elif "sun7i" in processor:
                print ("Detected processor: " + print_color(processor) + " (Probably Allwinner A20)")

            elif "sun8i" in processor:
                print ("Detected processor: " + print_color(processor) + " (Probably Allwinner A23/A33/A83T/H2+/H3/H8/R16/R40/R58/V3/V3s/V40)")

            elif "sun50i" in processor:
                print ("Detected processor: " + print_color(processor) + " (Probably Allwinner A64/H5/H6/H64)")
...
modules = [
    Extension('pySUNXI.gpio', sources=['pySUNXI/gpio/gpio_lib.c', 'pySUNXI/gpio/gpio.c']),

    Extension('pySUNXI.i2c', sources=['pySUNXI/i2c/i2c_lib.c', 'pySUNXI/i2c/i2c.c']),

    Extension('pySUNXI.spi', sources=['pySUNXI/spi/spi_lib.c', 'pySUNXI/spi/spi.c']),
]
